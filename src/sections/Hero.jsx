...
export default function Hero() {
  ...
  const maxCount = total > 0 ? Math.max(...poll.options.map((o) => results[o.id] || 0)) : 0

  return (
    <section id="hero" ref={ref} className="section shell shell--full hero" aria-labelledby="hero-title">
      ...
      <div className="container hero__inner">
        <div className="hero__top" data-reveal>
          ...
          <div className="hero__meter">
            ...
            <TensionMeter values={{ residents: 34, experts: 33, politics: 33 }} />
          </div>
        </div>
        ...
        <div className="hero__body">
          ...
          <div className="hero__right" data-reveal>
            <div className="hero__chart card" aria-label="Wyniki głosowania odwiedzających">
                  ...
                  return (
                    ...
                    >
                      <div className="chart-bar__meta">
                        ...
                        <span className="chart-bar__pct">{total > 0 ? `${pct}%` : '—'}</span>
                      </div>
                      <div className="chart-bar__track" role="progressbar" aria-valuenow={pct} aria-valuemin={0} aria-valuemax={100}>
                        <div className="chart-bar__fill" style={{ width: total > 0 ? `${pct}%` : '0%' }} />
                      </div>
                    </div>
                  )
                })}
